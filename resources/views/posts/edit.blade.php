        ...
        <div class="flex flex-col items-center min-h-screen ">
                    ...
                    <form method="post" action="{{ route('posts.update', ['id' => $post->id]) }}" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="text" cols="30" rows="2" class="shadow appearance-none border rounded w-full text-gray-700 focus:outline-none focus:shadow-outline" type="text" placeholder="Type here to post">
                                {{ $post->text }}
                            </textarea>
                        </div>
